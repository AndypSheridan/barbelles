...
### **Colour Scheme:**
​
After discussing various options with the site owner, Kate Ross, we opted for colour scheme 4 below generated by [Coolors](https://coolors.co/):

![Colour Palette](docs/images/barbelles-colour-palette.png)

About halfway through the project, we agreed the colours worked well, but Kate Ross, felt the site would benefit from the the addition of a brighter shade of pink to make things really stand out. We opted for #FF66B3. We also agreed #FFF (white) would work well in places.
